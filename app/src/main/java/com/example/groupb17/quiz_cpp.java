...
public class quiz_cpp extends AppCompatActivity {
    ...
    private void getQuizQuestion(ArrayList<QuizModal> quizModalArrayList) {
        quizModalArrayList.add(new QuizModal("1cpp",
                "//comment","\\comment", "==comment","<!-- comment",
                "//comment"));

        quizModalArrayList.add(new QuizModal("2cpp",
                "Program Container","Main Method", "Statement Block","Sentence",
                "Main Method"));

        quizModalArrayList.add(new QuizModal("3cpp",
                "full stop (.)","comma (,)", "semi colon (;)","exclamation mark (1)",
                "semi colon (;)"));

        quizModalArrayList.add(new QuizModal("4cpp",
                "0","2", "4","6",
                "0"));

        quizModalArrayList.add(new QuizModal("5cpp",
                "byte","boolean", "character","integer",
                "boolean"));

        quizModalArrayList.add(new QuizModal("6cpp",
                "int","byte", "short","double",
                "double"));

        quizModalArrayList.add(new QuizModal("7cpp",
                "/","//", "/*......*/","*/....*/",
                "\"/*......*/"));

        quizModalArrayList.add(new QuizModal("8cpp",
                "if","then", "goto","while",
                "goto"));

        quizModalArrayList.add(new QuizModal("9cpp",
                "1 and 2","2 and 3", "3 and 4","1 and 4",
                "3 and 4"));

        quizModalArrayList.add(new QuizModal("10cpp",
